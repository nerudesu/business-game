...
import com.ardhi.businessgame.activities.adapters.ContractAdapter;
import com.ardhi.businessgame.activities.adapters.PendingContractAdapter;
...
public class HeadquarterTabActivity extends TabActivity {
	...
	private Handler h;
	private Thread t;
	private ArrayList<String> sectors, userSectors, products, advertises, idAds,players;
	...
	public AlertDialog dialog(int d, final int productPos, final int adsPos, final int turn, final String idContract){
		...
		switch (d) {
			case 1:
				...
				txtPrice.setText((price*(userSectors.size())*sectorsLvl.get(sectorPos))+" ZE");
				...
				.setPositiveButton("Buy", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if(user.getMoney() < (price*(userSectors.size())*sectorsLvl.get(sectorPos)))
	...
	private class LoadHeadquarterData extends AsyncTask<String, Void, Object>{
		...
		protected void onPostExecute(Object res) {
			...
			if(res == null){
				...
				for(int i=0;i<array1.size();i++){
					userSectors.add(new Gson().fromJson(array1.get(i), String.class));
				}
				
				price = new Gson().fromJson(array.get(3), Double.class);
				...
				sales = new Gson().fromJson(array.get(6), Double.class);
				raw = new Gson().fromJson(array.get(7), Double.class);
				electricity = new Gson().fromJson(array.get(8), Double.class);
				fixed = new Gson().fromJson(array.get(9), Double.class);
				wage = new Gson().fromJson(array.get(10), Double.class);
				operation = new Gson().fromJson(array.get(11), Double.class);
				transport = new Gson().fromJson(array.get(12), Double.class);
				retribution = new Gson().fromJson(array.get(13), Double.class);
				advertisement = new Gson().fromJson(array.get(14), Double.class);
				interest = new Gson().fromJson(array.get(15), Double.class);
				depreciation = new Gson().fromJson(array.get(16), Double.class);
				tax = new Gson().fromJson(array.get(17), Double.class);
				cash = new Gson().fromJson(array.get(18), Double.class);
				rawOnStorage = new Gson().fromJson(array.get(19), Double.class);
				equipmentOnStorage = new Gson().fromJson(array.get(20), Double.class);
				loan = new Gson().fromJson(array.get(21), Double.class);
				storage = new Gson().fromJson(array.get(22), Double.class);
				equipment = new Gson().fromJson(array.get(23), Double.class);
				sector = new Gson().fromJson(array.get(24), Double.class);
				...
				array1 = parser.parse(new Gson().fromJson(array.get(29), String.class)).getAsJsonArray();
