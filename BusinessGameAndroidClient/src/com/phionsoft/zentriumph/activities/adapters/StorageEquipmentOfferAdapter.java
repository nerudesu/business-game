...
public class StorageEquipmentOfferAdapter extends BaseAdapter{

	private StorageTabActivity act;
	private ArrayList<MarketEquipment> equipments;
	private static LayoutInflater inflater = null;
	
	public StorageEquipmentOfferAdapter(StorageTabActivity a, ArrayList<MarketEquipment> e) {
		act = a;
		equipments = e;
	...
	public View getView(int pos, View newView, ViewGroup parent) {
		View v = newView;
		if(newView == null){
			v = inflater.inflate(R.layout.listrow_offered_equipment, null);
		}
		...
		btnCancel.setOnClickListener(new OnClickHandler(equipment.getId()));
		return v;
	}
